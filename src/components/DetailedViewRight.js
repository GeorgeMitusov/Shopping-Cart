    ...
    <div className="detailed-view-right">
      <div className="detailed-view-right-box">
        ...
        <div className="detailed-view-rating">
          <span className="detailed-view-rating-rate">Rate</span>
        ...
        <div className="detailed-view-nav">
          <button className="detailed-view-nav-add" onClick={handleQtyClick}>
            Add to cart
          </button>
          <button className="detailed-view-nav-buy" onClick={handleBuyNowClick}>
            Buy now
          </button>
        </div>
